...
import { Settings, ShieldCheck, KeyRound, Lock, Server, Cpu } from 'lucide-react';
import { isDemoMode } from '@/lib/config/env';

export const metadata = {
  title: 'System Settings & Security | Admin Dashboard',
};
    ...
    <div className="max-w-4xl space-y-6">
      <div className="border-b border-slate-800 pb-5">
        <h1 className="text-2xl font-black text-white flex items-center gap-2.5">
          ...
          <span>Platform Configuration & Security Posture</span>
        </h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2.5 text-xs text-slate-300">
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-900/90 border border-slate-800">
              ...
              <span className="font-mono font-bold text-amber-400">
                {isDemoMode ? 'APP_MODE=demo (Isolated Seed)' : 'APP_MODE=production (Strict Supabase)'}
              </span>
            </div>

            <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-900/90 border border-slate-800">
              <span>Service Role Secret Guard:</span>
              <span className="font-mono font-bold text-emerald-400">
                import &apos;server-only&apos; ACTIVE
              </span>
            </div>
            ...
            <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-900/90 border border-slate-800">
              ...
              <span className="font-mono font-bold text-emerald-400">
                Sliding-Window 5/min Login
              </span>
            </div>

            <div className="flex items-center justify-between p-2.5 rounded-xl bg-slate-900/90 border border-slate-800">
              <span>Private File Bucket Storage:</span>
              <span className="font-mono font-bold text-emerald-400">
                15m Signed URLs
              </span>
            </div>
        ...
        <div className="glass-panel rounded-3xl p-6 border border-slate-800 space-y-4">
          <h3 className="text-sm font-bold text-white uppercase tracking-wider flex items-center gap-2">
            ...
            <span>Administrator 2FA Status</span>
          </h3>
          ...
          <div className="p-3.5 rounded-xl bg-emerald-950/40 border border-emerald-500/40 text-xs text-emerald-200 space-y-1">
            <div className="flex items-center gap-1.5 font-bold text-emerald-300">
              <ShieldCheck className="w-4 h-4 text-emerald-400" />
              <span>TOTP 2FA Is Configured & Enforced</span>
            </div>
            <p className="text-[11px] text-slate-300">
              Backup codes (8 generated) are stored in secure SHA-256 hashed state.
            </p>
          </div>
